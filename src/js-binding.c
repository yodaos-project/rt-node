...
jerry_value_t js_call_function(const jerry_value_t jfunc,
...
void js_call_function_void(const jerry_value_t jfunc,
  const jerry_value_t jthis,
  const jerry_value_t jargv[],
  jerry_size_t jargc,
  const jerry_char_t *source) {
...
jerry_value_t js_call_function_no_tick(const jerry_value_t jfunc,
  const jerry_value_t jthis,
  const jerry_value_t jargv[],
  jerry_size_t jargc,
  const jerry_char_t *source) {
