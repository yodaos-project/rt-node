...
#
#  This file converts src/js/*.js to a C-array in src/js_js.[h|c] file.
# And this file also generates magic string list in src/js_string_ext.inl.h
...
HEADER1 = '''#ifndef _JS_SNAPSHOTS_H_
...
def js2c(options, js_modules):
    ...
    # str_const_regex = re.compile('^#define js_MAGIC_STRING_\w+\s+"(\w+)"$')
    # with open(fs.join(path.SRC_ROOT, 'js_magic_strings.in'), 'r') as fin_h:
    #     for line in fin_h:
    ...
    # magic_str_path = fs.join(path.SRC_ROOT, 'js_string_ext.inl.h')
